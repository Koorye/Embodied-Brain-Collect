...
整个 run 只发 P1_RUN_START(16)/P1_RUN_END(32) 两个 marker,与 paradigm1
的码约定一致;没有注视点/指令/想象等其他画面。Esc 中止也会补 RUN_END,
保证 EEG 对齐的码对完整。
