...
# \b 防止字段名误伤:wristband 的 npz 里有 parse_errors 字段,_save 的
# 字段清单行会把它写进日志,无边界时 "error" 子串会误报。
_LOG_ERROR = re.compile(r"\bERROR\b|FAILED|Traceback|crash", re.IGNORECASE)
_LOG_MAX = 5
