...
"""现有数据汇总 —— 对已采集的 session 做统计分析总结。
    ...
    python scripts/session_summary.py                       # data/session-night 当天
    python scripts/session_summary.py --all                 # 全部数据
...
from embodied_brain_collect.session.config import load_tasks  # noqa: E402
